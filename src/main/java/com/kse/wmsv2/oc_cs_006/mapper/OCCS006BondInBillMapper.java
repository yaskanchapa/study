...
@Mapper
public interface OCCS006BondInBillMapper {
    int updateBondInBill(Map paramMap);
    String selectCsImageManagement(String parm);
    List<String> selectFileName(String bondInBillNo);
    List<String> selectBiFileName(String bondInBillNo);
