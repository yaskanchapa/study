...
public class OCCS006SpReConstants {
    ...
    // メッセージ
    public static final String SP_RE_ERROR101 = "申告控作成処理中エラーが発生しました。[ERROR CODE: 101]";
    ...
    public static final String SP_RE_SUCCESS = "申告控作成が完了しました。";

    // Local用
    /** 輸出申告控作成用レポートPATH */
    public static final String SP_RE_EXP_PATH = "\\\\172.30.251.140\\Telegram\\Print\\Form\\spReExp.rrpt";
    /** 申告控作成用レポート出力PATH */
