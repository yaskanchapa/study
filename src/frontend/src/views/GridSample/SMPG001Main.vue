<template>
  <div style="width:1500px; height: 700px; margin-left: 50px;">
    <div style="margin-bottom: 5px;">
      <va-button color="info" @click="onChgAllRowBtnClicked()">ChgAllRow</va-button>
    </div>
  ...
  beforeMount() {
    this.columnDefs = [
      ...
      },
      {
        ...
        cellClass: ['ag-right-aligned-cell', 'cell-num-editable'],
      },
      { field: 'country',
        minWidth: 150,
        cellRenderer: 'gridSwitch'
    ...
    this.rowData = [
      { switch: false, numInput: 1, country: true, btn: false, date: '24/08/2008', sport: 'Swimming', gold: 8, silver: 0, bronze: 0, total: 8 },
      { switch: false, numInput: 2, country: false, btn: true, date: '24/08/2008', sport: 'Swimming', gold: 8, silver: 0, bronze: 0, total: 8 },
      { switch: true, numInput: 3, country: true, btn: false, date: '24/08/2008', sport: 'Swimming', gold: 8, silver: 0, bronze: 0, total: 8 },
      { switch: true, numInput: 4, country: false, btn: true, date: '24/08/2008', sport: 'Swimming', gold: 8, silver: 0, bronze: 0, total: 8 }
    ]
  },
  created() {
